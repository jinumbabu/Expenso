...
class Transactions extends Table {
  ...
  TextColumn get subcategoryId => text().nullable().references(Categories, #id).named('subcategory_id')();
  ...
  TextColumn get billStatus => text().nullable().named('bill_status')();
  ...
  TextColumn get aiClassification => text().nullable().named('ai_classification')();
  TextColumn get receiptUrl => text().nullable().named('receipt_url')();
  TextColumn get billLink => text().nullable().named('bill_link')();
  TextColumn get tags => text().nullable()();
  TextColumn get fingerprint => text().nullable().named('fingerprint')();
